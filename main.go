...
func init() {
	...
	_ = hypersdsv1alpha1.AddToScheme(scheme)
...
func main() {
	...
	if err = (&controllers.CephBlockPoolReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("CephBlockPool"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "CephBlockPool")
		os.Exit(1)
	}
